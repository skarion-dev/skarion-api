...
function buildBaseEmail({
  ...
  const finalLogoUrl = "http://localhost:5001/public/logo.svg"
  ...
  const finalHeroImageUrl ="http://localhost:5001/public/image.jpg"
                    ...
                    <td align="left" style="vertical-align:middle;">
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          ...
                          <td style="vertical-align:middle; font-size:18px; font-weight:700; color:#122461;">Skarion</td>
                        </tr>
                      </table>
                    </td>

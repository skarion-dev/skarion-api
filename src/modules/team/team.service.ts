...
export class TeamService {
  ...
  private async sendEmailInvite(
    ...
    const html = `<p>Dear ${firstName},</p><p>Thank you for enrolling in our ${course}. We’re excited to welcome you to Skarion and are truly glad to have you join our learning world.</p><p>To support you throughout the program, we’ve created a dedicated Microsoft Teams group chat where you’ll receive guidance, updates, and direct support from our instructors and team.</p><p>Please join the group using the link :<a href="${inviteLink}">Join the chat here</a></p><p>If you have any questions or need assistance at any point, feel free to reach out. We’re here to help you succeed.</p><p>Once again, welcome aboard. We look forward to supporting you on your journey into ${course}.</p><p>Warm regards,<br>Skarion</p>`;
